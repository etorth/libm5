...
BOOL cPetManager::Init()
{
	...
	ostringstream oss;
#if !defined(ccc_date)
	oss << g_MediaPath << "Êý¾Ý//ÕÙ»½ÊÞ//ÕÙ»½ÊÞÐÂ.txt";
#else
	oss << g_MediaPath << "ÕÙ»½ÊÞ//ÕÙ»½ÊÞÐÂ.txt";
#endif
	File.open(oss.str());
	File >> dustbin;
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath << "Êý¾Ý//ÕÙ»½ÊÞ//ÕÙ»½ÊÞÕ½¶·Æ«ÒÆ±í.txt";
#else	
	oss << g_MediaPath << "ÕÙ»½ÊÞ//ÕÙ»½ÊÞÕ½¶·Æ«ÒÆ±í.txt";
#endif
	File2.open(oss.str());
	oss.str("");
#if !defined(ccc_date)	
	oss << g_MediaPath << "Êý¾Ý//ÕÙ»½ÊÞ//ÕÙ»½ÊÞ.txt";
#else
	oss << g_MediaPath << "ÕÙ»½ÊÞ//ÕÙ»½ÊÞ.txt";
#endif
	File.open(oss.str());
	File >> dustbin;
	File2 >> dustbin2;
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath << "Êý¾Ý//ÕÙ»½ÊÞ//ÕÙ»½ÊÞÉùÒô.txt";
#else
	oss << g_MediaPath << "ÕÙ»½ÊÞ//ÕÙ»½ÊÞÉùÒô.txt";
#endif
	File.open(oss.str());
