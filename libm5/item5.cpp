...
#if defined(ccc_date)
	string myWeaponPath = g_MediaPath + "武器//";
	string myEquipPath = g_MediaPath + "装备//";
#else 
	string myWeaponPath = g_MediaPath + "数据//武器//";
	string myEquipPath = g_MediaPath + "数据//装备//";
#endif
...
#pragma omp  section
		{
			...
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\药品.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\烹饪.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\法宝.txt";
			LoadFaBao(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\兽决.txt";
			LoadShouJue(oss.str());
		}
#pragma omp  section
		{
			ostringstream oss;
			oss << g_MediaPath << "道具列表\\暗器.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\变身卡.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\道具.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\不可叠加道具.txt";
			LoadItem1(oss.str());
		}
#pragma omp  section
		{
			ostringstream oss;
			oss << g_MediaPath << "道具列表\\花.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\宝石.txt";
			LoadItem1(oss.str());
			oss.str("");
...
// 			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\乐器.txt";
			LoadItem1(oss.str());
			oss.str("");
			oss << g_MediaPath << "道具列表\\家具.txt";
			LoadJiaJu(oss.str());
		}
#pragma omp  section
	{
...
#pragma omp  section
		{
			...
			int num,ID;
			ostringstream oss;
			oss << g_MediaPath << "道具列表\\物品类型名.txt";
			File.open(oss.str());
			if (!File)ERRBOX;
			File >> num;
			string name;
