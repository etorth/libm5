...
BOOL cSkillManager::Init()
{
	...
	ostringstream oss;
#if !defined(ccc_date)
	oss << g_MediaPath << "数据//技能//召唤兽技能.txt";
#else
	oss << g_MediaPath << "技能//召唤兽技能.txt";
#endif
	File.open(oss.str());
	if (!File)ERRBOX;
	int dustbin;
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath << "数据//技能//辅助技能.txt";
#else
	oss << g_MediaPath << "技能//辅助技能.txt";
#endif
	File.open(oss.str());
	if (!File)ERRBOX;
	File >> dustbin;
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath << "数据//技能//特技.txt";
#else
	oss << g_MediaPath << "技能//特技.txt";
#endif
	File.open(oss.str());
	if (!File)ERRBOX;
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath << "数据\\技能\\特技声音.txt";
#else
	oss << g_MediaPath << "技能\\特技声音.txt";
#endif
	File.open(oss.str());
	if (!File)ERRBOX;
	int soundnum;
...
BOOL cMengPaiManager::Init()
{
	...
	ostringstream oss;
#if !defined(ccc_date)
	oss << g_MediaPath << "数据//技能//师门技能.txt";
#else
	oss << g_MediaPath << "技能//师门技能.txt";
#endif
	File.open(oss.str());
	int dustbin;
	File >> dustbin;
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath<<"数据//技能//师门技能声音.txt";
#else
	oss << g_MediaPath<<"技能//师门技能声音.txt";
#endif
	File.open(oss.str());
	if (!File)
	{
	...
	oss.str("");
#if !defined(ccc_date)
	oss << g_MediaPath << "数据//技能//门派.txt";
#else
	oss << g_MediaPath << "技能//门派.txt";
#endif
	File.open(oss.str());
	File >> dustbin;
